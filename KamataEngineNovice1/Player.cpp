	...
	switch (state_) {
		case PlayerState::OnGround:
			if (mousePosX < obj_.position.x) {
				Novice::DrawSpriteRect((int)obj_.position.x, (int)obj_.position.y, (int)frameNum_ * (int)PLAYER_WIDTH, 0, (int)obj_.width, (int)obj_.height, textureHandleLeft_, 1.0f / MAX_IDLEFRAME, 1.0f, 0.0f, WHITE);
			}
			else if (mousePosX > obj_.position.x) {
				Novice::DrawSpriteRect((int)obj_.position.x, (int)obj_.position.y, (int)frameNum_ * (int)PLAYER_WIDTH, 0, (int)obj_.width, (int)obj_.height, textureHandleRight_, 1.0f / MAX_IDLEFRAME, 1.0f, 0.0f, WHITE);
			}
			break;

		case PlayerState::UnderGround:
			Novice::DrawSpriteRect((int)obj_.position.x, (int)obj_.position.y, (int)frameNum_ * (int)PLAYER_WIDTH, 0, (int)obj_.width, (int)obj_.height, textureHandleUnder_, 1.0f / MAX_IDLEFRAME, 1.0f, 0.0f, WHITE);
			break;

		case PlayerState::Up:
			Novice::DrawSpriteRect((int)obj_.position.x, (int)obj_.position.y, (int)upFrame_ * (int)PLAYER_WIDTH, 0, (int)obj_.width, (int)obj_.height, textureHandleUp_, 1.0f / MAX_UPFRAME, 1.0f, 0.0f, WHITE);
			break;

		case PlayerState::Down:
			Novice::DrawSpriteRect((int)obj_.position.x, (int)obj_.position.y, (int)downFrame_ * (int)PLAYER_WIDTH, 0, (int)obj_.width, (int)obj_.height, textureHandleDown_, 1.0f / MAX_DOWNFRAME, 1.0f, 0.0f, WHITE);
			break;
	}
